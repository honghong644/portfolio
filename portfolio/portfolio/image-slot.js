...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 \"Space Mono\",ui-monospace,monospace;color:rgba(245,245,245,.5);width:240px;height:160px}' +
    '.frame{position:absolute;inset:0;overflow:hidden;background:rgba(245,245,245,.035)}' +
    ...
    '.empty .sub u{text-underline-offset:2px;text-decoration-color:rgba(245,245,245,.35)}' +
    '.empty:hover .sub u{color:rgba(245,245,245,.9);text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #c96442;outline-offset:-2px;' +
    '  background:rgba(201,100,66,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1px dashed rgba(245,245,245,.22);' +
